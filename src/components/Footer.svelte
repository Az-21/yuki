...
<div
	class="flex w-full mx-auto overflow-hidden bg-gray-700 rounded-lg shadow-md dark:bg-gray-800 {vSpacing} {horizontal}"
>
	...
	<div class="px-4 py-2 -mx-3">
		<div class="mx-3">
			<span class="font-bold text-blue-500">Disclaimer</span>
